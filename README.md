...
1. **Frontend (Storefront):** Giao diện trực quan, hiện đại giúp khách hàng dễ dàng tìm kiếm, xem chi tiết thông số kỹ thuật các dòng xe (Vision, SH, Air Blade...) và gửi yêu cầu đăng ký mua.
...
* **Frontend:** Blade Template, Bootstrap 5, HTML5/CSS3, FontAwesome.
* **Database:** MySQL.
* **Tools/Environment:** Git, GitHub, XAMPP/Laragon, Antigravity.
...
* **Dashboard Thống kê:** Theo dõi biến động doanh thu, tổng số đơn hàng và lượng khách hàng.
* **Quản lý Xe máy (Motorcycle Management):** * Thực hiện các thao tác Thêm, Xem, Sửa, Xóa (CRUD).
  * Tích hợp **Soft Deletes (Xóa mềm)**: Hỗ trợ khôi phục xe đã xóa từ Thùng rác.
* **Quản lý Đơn hàng (Order Management):** Theo dõi và thay đổi trạng thái xử lý của từng đơn hàng.
* **Tối ưu hóa (Optimization):** Sử dụng kỹ thuật *Eager Loading* để giải quyết triệt để lỗi N+1 Query.

---

## 🛠 Hướng dẫn cài đặt (Installation Guide)

Vui lòng làm theo các bước dưới đây để khởi chạy dự án trên môi trường Localhost (XAMPP/Laragon):
